...
- **For Teachers**: Additional income opportunity through a simple, gamified reporting mechanism
...
| **Payouts** | Points system, payout calculation, integration with treasury/DBT |
| **Gamification** | Leaderboards, streak bonuses, achievement badges |
...
| TDASH-02 | Points balance and breakdown (base + bonuses) | P0 |
| TDASH-03 | Payout history with transaction IDs | P0 |
| TDASH-04 | Leaderboard position (block-level, district-level) | P1 |
| TDASH-05 | Notification center for status updates | P0 |
...
| PTS-05 | Points-to-currency conversion: 1 point = ₹1 | P0 |
| PTS-06 | Monthly payout cap: ₹5,000 per teacher | P0 |

#### 6.3.2 Payout Processing
...
| DAD-04 | Leaderboard: top performing blocks and teachers | P1 |
...
| points_awarded | Integer | Points for this incident |
...
| total_points | Integer | Points earned in period |
...
| System | Integration Type | Data Exchanged |
|--------|-----------------|----------------|
| Treasury/DBT | File upload / API | Payout files (teacher ID, amount, bank details) |
...
| **Phase 4: Optimization** | Full scale with advanced features | Ongoing | Gamification v2, route optimization, AI improvements |
...
|------|------------|--------|------------|
| Low teacher adoption | Medium | High | Gamification, district-level competitions, peer influence |
...
|---------|------|--------|---------|
| 0.1 | Dec 2024 | [Author] | Initial draft |
| 1.0 | Dec 2024 | [Author] | Incorporated policy decisions, finalized scope |
