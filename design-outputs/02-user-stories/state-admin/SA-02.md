...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│ 📊 District Comparison                                     December 2026    │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  Select Districts to Compare (max 5):                                       │
│  ┌─────────────┐ ┌─────────────┐ ┌─────────────┐ ┌─────────────┐ ┌────────┐│
│  │ Patna     ✓ │ │ Gaya      ✓ │ │ Muzaffar- ✓ │ │ Bhagalpur ✓ │ │ + Add  ││
│  │             │ │             │ │ pur         │ │             │ │        ││
│  └─────────────┘ └─────────────┘ └─────────────┘ └─────────────┘ └────────┘│
│                                                                             │
│  ┌─────────────────────────────────────────────────────────────────────────┐│
...
│  ├──────────────┬──────────┬──────────┬────────────┬────────────┬─────────┤│
│  │ Metric       │ Patna    │ Gaya     │ Muzaffarpur│ Bhagalpur  │ State   ││
│  │              │          │          │            │            │ Avg     ││
│  ├──────────────┼──────────┼──────────┼────────────┼────────────┼─────────┤│
│  │ Teachers     │  2,340   │  1,890   │   1,456    │   1,234    │  1,128  ││
│  │ Active       │  1,217   │   850    │    553     │    432     │   474   ││
│  │ Participation│   52% ⬆  │   45%    │    38%     │    35% ⬇   │   42%   ││
│  ├──────────────┼──────────┼──────────┼────────────┼────────────┼─────────┤│
│  │ Submissions  │  8,234   │  6,890   │   5,234    │   4,567    │  4,256  ││
│  │ Verified     │  7,123   │  5,678   │   4,345    │   3,890    │  3,567  ││
│  │ Ver. Rate    │   87% ⬆  │   82%    │    83%     │    85%     │   84%   ││
│  ├──────────────┼──────────┼──────────┼────────────┼────────────┼─────────┤│
│  │ Captured     │  5,890   │  4,567   │   3,456    │   3,123    │  2,890  ││
│  │ Capture Rate │   83%    │   80%    │    80%     │    80%     │   81%   ││
│  ├──────────────┼──────────┼──────────┼────────────┼────────────┼─────────┤│
│  │ Fraud Cases  │    23    │    18    │     31     │     12     │    15   ││
│  │ Fraud Rate   │  0.28%   │  0.26%   │   0.59% ⚠  │   0.26%    │  0.35%  ││
│  ├──────────────┼──────────┼──────────┼────────────┼────────────┼─────────┤│
│  │ Total Payout │ ₹29.45L  │ ₹22.84L  │  ₹17.28L   │  ₹15.62L   │ ₹14.45L ││
│  │ Per Capture  │  ₹500    │  ₹500    │   ₹500     │   ₹500     │  ₹500   ││
│  │ Avg/Teacher  │ ₹2,419   │ ₹2,687   │  ₹3,125 ⚠  │  ₹3,616 ⚠  │ ₹3,048  ││
│  └──────────────┴──────────┴──────────┴────────────┴────────────┴─────────┘│
│                                                                             │
│  Legend: ⬆ Best performer  ⬇ Lowest  ⚠ Outlier (>1.5× std dev)            │
│                                                                             │
│  ┌─────────────────────────────────────────────────────────────────────────┐│
│  │  📈 Trend Comparison (Last 6 Months)                                    ││
│  ├─────────────────────────────────────────────────────────────────────────┤│
│  │                                                                         ││
...
│                                                                             │
│  ┌─────────────────────────────────────────────────────────────────────────┐│
│  │  🏆 State Rankings (All 38 Districts)                 [By: Part. Rate]  ││
│  ├─────────────────────────────────────────────────────────────────────────┤│
│  │                                                                         ││
│  │  Rank  District           Part.Rate  Ver.Rate  Fraud    Trend          ││
│  │  ───────────────────────────────────────────────────────────────────── ││
│  │  1.    Patna              52%        87%       0.28%    ↑5%            ││
│  │  2.    Samastipur         49%        85%       0.32%    ↑3%            ││
│  │  3.    Nalanda            48%        84%       0.25%    ↑4%            ││
│  │  4.    Gaya               45%        82%       0.26%    ↑2%            ││
│  │  ...                                                                    ││
│  │  35.   Kishanganj         28%        78%       0.45%    ↓1%            ││
│  │  36.   Araria             26%        76%       0.52%    ↓2%            ││
│  │  37.   Katihar            24%        75%       0.48%    ↓3%            ││
│  │  38.   Purnia             22%        74%       0.55%    ↓4%            ││
│  │                                                                         ││
│  │                                              [View Full Rankings]       ││
│  └─────────────────────────────────────────────────────────────────────────┘│
│                                                                             │
│                     [Export Comparison] [Save as Template] [Share Report]   │
└─────────────────────────────────────────────────────────────────────────────┘
```
          ...
          {selectedDistricts.map(id => {
            ...
            return (
              <div key={id} className="selected-district-chip">
                {district?.name}
                <button onClick={() => removeDistrict(id)}>×</button>
              </div>
            );
          })}
      ...
      {comparisonData && (
        <div className="metrics-table-section">
          ...
          <div className="table-legend">
            <span className="legend-item">⬆ Best performer</span>
            <span className="legend-item">⬇ Lowest</span>
            <span className="legend-item">⚠ Outlier (&gt;1.5× std dev)</span>
          </div>
        </div>
      )}
...
function MetricRow({ label, data, metric, stateAvg, format, highlightBest, lowerIsBetter }) {
  ...
  const formatValue = (value) => {
    ...
    if (format === 'currency') return `₹${(value / 100000).toFixed(2)}L`;
