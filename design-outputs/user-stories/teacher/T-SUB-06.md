...
- [ ] ID format: `SDCRS-YYYYMMDD-XXXXX` (e.g., SDCRS-20241207-A1B2C)
...
| Date | Submission date (YYYYMMDD) | 20241207 |
...
Application ID: SDCRS-20241207-A1B2C
Status: Pending Verification

Track status: https://sdcrs.gov.dj/status/SDCRS-20241207-A1B2C
```
