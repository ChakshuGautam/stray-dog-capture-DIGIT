...
│  │  ●───────────────────────────────────────────────  │   │
│  │  │ VERIFIED                                        │   │
│  │  │ Jan 15, 2024 at 10:45 AM                       │   │
│  │  │ Report verified and approved                    │   │
│  │  │                                                 │   │
│  │  ●───────────────────────────────────────────────  │   │
│  │  │ ROUTED                                          │   │
│  │  │ Jan 15, 2024 at 10:46 AM                       │   │
...
```json
{
  "incident": {
    ...
    "auditHistory": [
      { "action": "CREATED", "timestamp": "2024-01-15T10:30:00Z" },
      { "action": "VERIFIED", "timestamp": "2024-01-15T10:45:00Z" }
    ]
  }
}
```
